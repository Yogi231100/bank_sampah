...
<head>
    ...
    <style>
        ...
        #sidebar .sidebar-header {
            ...
            background: linear-gradient(to bottom, #1abc9c, #16a085); /* Menggunakan gradasi yang sama dengan sidebar */
            text-align: center;
        }
        ...
        .navbar {
            ...
            background: linear-gradient(to right, #1abc9c, #16a085); /* Gradasi hijau yang sama dengan sidebar */
        ...
        .navbar .btn-outline-secondary:hover {
            background-color: rgba(255, 255, 255, 0.1); /* Background hover tombol */
            color: #fff;
        }
        ...
        .navbar .btn-outline-danger {
            ...
            border-color: #f1c40f; /* Warna border tombol logout yang lebih kontras */
            background-color: #f39c12; /* Background tombol logout */
        }
        .navbar .btn-outline-danger:hover {
            background-color: #e67e22; /* Background hover tombol logout */
            border-color: #e67e22;
            color: #fff;
        }
        ...
        .navbar .small {
            color: #ecf0f1; /* Warna teks agar kontras dengan background gradasi hijau */
        }
...
<div class="wrapper">
    ...
    <div id="content">
        <nav class="navbar navbar-expand-lg navbar-light"> <div class="container-fluid">
